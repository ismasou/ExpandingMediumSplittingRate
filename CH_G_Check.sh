...
./Static2D.out -P 16 -T 0.2 -z 0.1875 -Process Q_GQ
echo -e "${BOLDRED}Running second set of simulations${RESET}"
./Static2D.out -P 16 -T 0.2 -z 0.5 -Process Q_GQ
echo -e "${BOLDRED}Running third set of simulations${RESET}"
./Static2D.out -P 16 -T 0.4 -z 0.1875 -Process Q_GQ
echo -e "${BOLDRED}Running fourth set of simulations${RESET}"
./Static2D.out -P 16 -T 0.4 -z 0.5 -Process Q_GQ

# Copy results to CH_G_Comparison
echo -e "${BOLDRED}Copying results to CH_G_Comparison${RESET}"
cp -f Output/Static2D/rate_P16_z0.1875_T0.2.dat CH_G_Comparison/rate2D-0.2_3.dat
cp -f Output/Static2D/rate_P16_z0.1875_T0.4.dat CH_G_Comparison/rate2D-0.4_3.dat
cp -f Output/Static2D/rate_P16_z0.5_T0.2.dat    CH_G_Comparison/rate2D-0.2_8.dat
cp -f Output/Static2D/rate_P16_z0.5_T0.4.dat    CH_G_Comparison/rate2D-0.4_8.dat
